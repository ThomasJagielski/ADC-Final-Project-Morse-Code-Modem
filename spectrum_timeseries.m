function varargout = spectrum_timeseries(x,varargin) 
...
% To use default threshold for plotTFR, do not pass in a threshold field
% with plotOpts.
% If threshold is 0, it means it was not specified by the user.
if(threshold>0)
